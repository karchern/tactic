...
This file specifies important parameters for the analysis, including
- z-score- and colony-size thresholds
- Specifications regarding the number of biological-, technical- and plate-replicates (for elucidation see XXX) #TODO: elucidate this graphically somewhere

```{r}
yaml::read_yaml('./input/config.yaml')
```
