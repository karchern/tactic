This script was initially written by Vallo Varik, to whom much of the credit should go.

# Get ready 

```{r setup, include=F}
pacman::p_load(data.table, tidyverse, ggrepel, GGally, scales, ComplexHeatmap, limma, Biobase, cowplot)
